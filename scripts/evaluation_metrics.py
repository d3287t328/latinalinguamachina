...
def calculate_perplexity(probabilities):
    ...
    # then we calculate the perplexity as e to the power of the negative average log probability
...
def calculate_bleu_score(candidate_sentences, reference_sentences):
    ...
    # then we calculate the BLEU score using the corpus_bleu function from the nltk library
